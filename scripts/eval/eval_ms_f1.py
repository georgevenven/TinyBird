...
def main() -> None:
    ...
    parser.add_argument("--ms_per_timebin", type=int, default=2, help="Milliseconds per timebin (default: 2)")
    ...
    for fn, max_t in file_max_timebin.items():
        units = annotations.get(fn, [])
        labels_by_file[fn] = _labels_from_units(units, max_t, args.ms_per_timebin, args.mode)
